...
public class Screenshot {
    ...
    public static void getPageScreenshot(String name) {
        var scrFile = ((TakesScreenshot) Driver.getInstance()).getScreenshotAs(OutputType.FILE);
        try {
            FileUtils.copyFile(scrFile,
                    new File( "target" + File.separator + "screenshot" + File.separator + "page-screenshot" +
                            "./"+ Driver.getInstance().getTitle() + "_" + name + "_" + Driver.getInstance().getSessionId() + "_" + ".png"));
    ...
    public static void getElementScreenshot(WebElement webElement, String name) {
        var scrFile = webElement.getScreenshotAs(OutputType.FILE);
        try {
            FileUtils.copyFile(scrFile,
                    new File( "target" + File.separator + "screenshot" + File.separator + "element-screenshot" +
                            "./"+ Driver.getInstance().getTitle() + "_" + name + "_" + Driver.getInstance().getSessionId() + "_" + ".png"));
